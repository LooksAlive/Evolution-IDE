...
NodeScene::NodeScene(QObject *parent) : QGraphicsScene(parent) {
    ...
    connect(this, &NodeScene::connectionCreated, this, &NodeScene::setupConnectionSignals);
    connect(this, &NodeScene::connectionCreated, this, &NodeScene::sendConnectionCreatedToNodes);
    connect(this, &NodeScene::connectionDeleted, this, &NodeScene::sendConnectionDeletedToNodes);
}
...
namespace QtNodes {
    ...
    Node *
    locateNodeAt(QPointF scenePoint, NodeScene &scene,
